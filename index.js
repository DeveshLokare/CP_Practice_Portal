...
import { differenceInDays } from "date-fns";  // Ensure date-fns is imported
...
app.get("/profile", async (req, res) => {
  try {
    ...
    res.render("index.ejs", { username: currentUser, streak: user.streak });
  } catch (err) {
...
app.get("/problems", async (req, res) => {
  try {
    ...
    res.render("problems.ejs", { problems, username: currentUser, streak,user , currentPage: page,
...
app.get("/contests", async (req, res) => {
  ...
  res.render("contests.ejs", { contests: paginatedContests, username: currentUser,currentPage: page,
...
app.get('/favourites', async (req, res) => {
  try {
    ...
    res.render('favourites.ejs', { favourites: favouriteProblems, username: currentUser, streak: user.streak });
  } catch (err) {
